...
if (currentUser) {
  ...
  if (ctx) {
    ...
    let box = document.getElementById("balance-list");
    ...
    if (group.members.length === 0) {
      ...
      */
      ...
      for (let name in balances) {
        ...
        let width = (Math.abs(balance) / maxAbs) * 50;
